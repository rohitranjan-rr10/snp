...
<body id="body-pd">
            ...
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a class="nav__link active">
                        <ion-icon name="trash" class="nav__icon"></ion-icon>
    ...
    <script>
                    ...
                    .then(data => {
                        if (Array.isArray(data) && data.length > 0) { 
                            ...
                            data.forEach((row, index) => {
                                ...
                                tableHtml += '<td><button class="btn btn-danger" onclick="deleteRow(' + index + ', ' + row.serial_number + ')">Delete</button></td>';
        ...
        function deleteRow(jsonIndex, serialNumber) {
            if (confirm('Are you sure you want to delete this record?')) {
                fetch('../includes/delete_record.php?json_index=' + jsonIndex + '&serial_number=' + serialNumber)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
